  ...
  return (
    <div className={styles.mainWrapper}>
      ...
      <div className={styles.mainInfo}>
        ...
        <div className={styles.subButtonWrapper}>
          <div className={styles.buttonsWrapper}>
            <div className={styles.price}>{data.productPrice} ₴</div>
      ...
      <div className={`${styles.characteristic} ${styles.textBox}`}>
        <div className={styles.blueText}>Характеристики</div>
        <Characteristic title={'Вік'} message={data.minAge} />
        <Characteristic
          title={'Кількість гравців'}
          message={`${data.minPlayers}-${data.maxPlayers}`}
        />
        <Characteristic
          title={'Час партії'}
...
const Characteristic = ({ title, message }) => {
  ...
  return (
    <div className={styles.characteristicRow}>
      <div className={styles.greyText}>{title}</div>
